...
var TalkArea=[
				...
				{ name: "天津", cities: ["青羊", "河东", "河西", "南开", "河北", "红桥", "塘沽", "汉沽", "大港", "东丽", "西青", "北辰", "津南", "武清", "宝坻", "静海", "宁河", "蓟县", "开发"] },
				...
				{ name: "重庆", cities: ["渝中", "大渡口", "江北", "沙坪坝", "九龙坡", "南岸", "北碚", "万盛", "双桥", "渝北", "巴南", "万州", "涪陵", "黔江", "长寿"] },
			 	...
			 	{ name: "吉林", cities: ["长春", "吉林", "四平", "辽源", "通化", "延吉", "白城", "松原", "临江", "珲春"] },
			 	{ name: "黑龙江", cities: ["哈尔滨", "齐齐哈尔", "大庆", "牡丹江", "鹤岗", "佳木斯", "绥化"] },
			  	...
			  	{ name: "贵州", cities: ["贵阳", "六盘水", "遵义", "铜仁", "毕节", "安顺", "黔西南", "黔东南", "黔南", "兴义"] },
			  	{ name: "云南", cities: ["昆明", "丽江", "昭通", "玉溪", "临沧", "文山", "红河", "楚雄", "大理"] },
			  	{ name: "西藏", cities: ["拉萨", "林芝", "日喀则", "昌都"] },
			  	{ name: "陕西", cities: ["西安", "咸阳", "延安", "汉中", "榆林", "商南", "略阳", "宜君", "麟游", "白河", "铜川"] },
			  	{ name: "甘肃", cities: ["兰州", "金昌", "天水", "武威", "张掖", "平凉", "酒泉"] },
			  	{ name: "青海", cities: ["黄南", "海南", "西宁", "海东", "海西", "海北", "果洛", "玉树"] },
			  	{ name: "宁夏", cities: ["银川", "吴忠"] },
			  	{ name: "新疆", cities: ["乌鲁木齐", "哈密", "喀什", "巴音郭楞", "昌吉", "伊犁", "阿勒泰", "克拉玛依", "博尔塔拉", "吐鲁番"] },
			  	{ name: "香港", cities: ["中西", "湾仔", "东区", "南区", "九龙-油尖旺", "九龙-深水埗", "九龙-九龙城", "九龙-黄大仙", "九龙-观塘", "新界-北", "新界-大埔", "新界-沙田", "新界-西贡", "新界-荃湾", "新界-屯门", "新界-元朗", "新界-葵青", "新界-离岛"] },
			  	{ name: "澳门", cities: ["花地玛堂", "圣安多尼堂", "大堂", "望德堂", "风顺堂", "嘉模堂", "圣方济各堂", "路氹城"]}];
